# Watchlist – Bullrun Coins

Übersicht aller Coins, die für den nächsten Bullrun infrage kommen.
...
➡️ **Gesamtvergleich und Portfolio-Vorschlag: [[00 Vergleich & Portfolio]]**

## Status-Legende

- **Idee** – nur erwähnt/gelistet, noch keine Recherche
- **In Recherche** – Coin-Datei existiert, wird gerade bearbeitet
- **Recherchiert** – alle Punkte aus der Vorlage bearbeitet
- **Verworfen** – aus der engeren Auswahl raus
- **Gekauft**
...
| **Polkadot (DOT)** | Recherchiert | $1,38 Mrd. | ~#55§ | $0,805 | **-98,5 %** | ⭐⭐ mittel/Turnaround | [[Polkadot (DOT)]] |
...
### Neu recherchiert am 10.08.2026 – Polkadot (DOT)

**Der Coin mit der besten 10x-Mathematik des Vaults – und den schlechtesten Trendindikatoren.**

| | |
|---|---|
| **Dafür** | 10x = nur **$14 Mrd. MC = 26 % des alten ATH-Niveaus** (bestes Verhältnis im Vault). Tokenomics im März 2026 repariert: **harte 2,1-Mrd.-Obergrenze**, Inflation von 7–10 % auf **~3 %**, MC/FDV 81 %, keine Unlocks. Gavin Wood, bestes Chain-Framework der Branche. Grayscale-ETF-Verfahren läuft. Über Trade Republic wahrscheinlich direkt kaufbar |
...
| | |
|---|---|
| Gesamt-Market-Cap Krypto | **$2,29 Bio.** |
| ATH Gesamtmarkt | $4,82 Bio. (05.10.2025) |
| **Abstand zum ATH** | **-52,6 %** |
| BTC-Dominanz | 56,2 % |

→ Wir befinden uns in einem tiefen Bärenmarkt. Das ist die Phase, in der 10x-Positionen aufgebaut werden – aber es bedeutet auch, dass der Boden möglicherweise noch nicht erreicht ist. **Gestaffelt kaufen, nicht auf einmal.**
